...
namespace IO.Swagger.Model
{
    ...
    public partial class ContactResponse :  IEquatable<ContactResponse>, IValidatableObject
    {
        ...
        public ContactResponse(DetailResponse Name = default(DetailResponse), AddressResponse Address = default(AddressResponse), double? Score = default(double?), Object WebsiteUrl = default(Object), Object Email = default(Object), DetailResponse Phone = default(DetailResponse), DetailResponse Fax = default(DetailResponse))
        {
            this.Name = Name;
