...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CountedInvoicesResponse :  IEquatable<CountedInvoicesResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CountedInvoicesResponse" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CountedInvoicesResponse() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CountedInvoicesResponse" /> class.
        /// </summary>
        ...
        public CountedInvoicesResponse(int? Count = default(int?), int? State = default(int?), string Message = default(string))
        {
            // to ensure "State" is required (not null)
            if (State == null)
            {
                throw new InvalidDataException("State is a required property for CountedInvoicesResponse and cannot be null");
            }
            else
            {
                this.State = State;
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as CountedInvoicesResponse);
        }
