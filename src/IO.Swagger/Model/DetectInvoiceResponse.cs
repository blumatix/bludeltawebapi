...
namespace IO.Swagger.Model
{
    ...
    public partial class DetectInvoiceResponse :  IEquatable<DetectInvoiceResponse>, IValidatableObject
    {
        ...
        /// </summary>
        /// <value>The receiver of the invoice</value>
        ...
        public bool Equals(DetectInvoiceResponse other)
        {
            ...
            return 
                ...
                (
                    this.OcrWordQuality == other.OcrWordQuality ||
                    this.OcrWordQuality != null &&
                    this.OcrWordQuality.Equals(other.OcrWordQuality)
                ) && 
                (
                    this.MeanCharacterConfidenceValue == other.MeanCharacterConfidenceValue ||
                    this.MeanCharacterConfidenceValue != null &&
                    this.MeanCharacterConfidenceValue.Equals(other.MeanCharacterConfidenceValue)
                ) && 
                (
                    this.StdDevCharacterConfidenceValue == other.StdDevCharacterConfidenceValue ||
                    this.StdDevCharacterConfidenceValue != null &&
                    this.StdDevCharacterConfidenceValue.Equals(other.StdDevCharacterConfidenceValue)
                ) && 
                (
                    this.MaxCharacterConfidenceValue == other.MaxCharacterConfidenceValue ||
                    this.MaxCharacterConfidenceValue != null &&
                    this.MaxCharacterConfidenceValue.Equals(other.MaxCharacterConfidenceValue)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            ...
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.OcrWordQuality != null)
                    hash = hash * 59 + this.OcrWordQuality.GetHashCode();
                if (this.MeanCharacterConfidenceValue != null)
                    hash = hash * 59 + this.MeanCharacterConfidenceValue.GetHashCode();
                if (this.StdDevCharacterConfidenceValue != null)
                    hash = hash * 59 + this.StdDevCharacterConfidenceValue.GetHashCode();
                if (this.MaxCharacterConfidenceValue != null)
                    hash = hash * 59 + this.MaxCharacterConfidenceValue.GetHashCode();
