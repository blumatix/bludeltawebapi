...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class InvoiceContainerKeepAliveLockResponse :  IEquatable<InvoiceContainerKeepAliveLockResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InvoiceContainerKeepAliveLockResponse" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InvoiceContainerKeepAliveLockResponse() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InvoiceContainerKeepAliveLockResponse" /> class.
        /// </summary>
        /// <param name="State">0 &#x3D; Ok, 1 &#x3D; Failed (required).</param>
        /// <param name="Message">Error message in case of an error.</param>
        public InvoiceContainerKeepAliveLockResponse(int? State = default(int?), string Message = default(string))
        {
            // to ensure "State" is required (not null)
            if (State == null)
            {
                throw new InvalidDataException("State is a required property for InvoiceContainerKeepAliveLockResponse and cannot be null");
            }
            else
            {
                this.State = State;
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as InvoiceContainerKeepAliveLockResponse);
        }
