...
namespace IO.Swagger.Model
{
    ...
    public partial class DetectionResponse :  IEquatable<DetectionResponse>, IValidatableObject
    {
        ...
        public DetectionResponse(int? Type = default(int?), string TypeName = default(string), string Value = default(string), double? Score = default(double?), int? X = default(int?), int? Y = default(int?), int? Width = default(int?), int? Height = default(int?))
        {
