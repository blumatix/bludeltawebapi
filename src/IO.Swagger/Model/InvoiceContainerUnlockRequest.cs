...
{
  /// <summary>
  ///   After processing the container (or after navigating to the next container without saving) the container needs to be
  ///   unlocked.
  /// </summary>
  [DataContract]
  public class InvoiceContainerUnlockRequest : IEquatable<InvoiceContainerUnlockRequest>, IValidatableObject
  {
    /// <summary>
    ...
    {
      // credit: http://stackoverflow.com/a/10454552/677735
      return Equals(obj as InvoiceContainerUnlockRequest);
    }
